    ...
    publicWidget.Widget.include({
        ...
        init_form: function () {
            ...
            $(document).ready(function(){
               console.log("website_checkout_sunat init_form"); 
            });
            ...
            $('input[name=l10n_latam_identification_type_id]').on('change', function () {
                ...
                var l10n_latam_identification_timer = setInterval(function () 
                    {
                        if($('input#l10n_latam_identification_type_id').length > 0)
                            {
                               var l10n_latam_identification_type_id_data = $('input#l10n_latam_identification_type_id').select2('data');
                                ...
                                clearInterval(l10n_latam_identification_timer); 
                            }               
                    ...
                    if (data.read_results) {
                        ...
                        if (read_results.length > 0) {
                            try
                            {
                                ...
                                var l10n_latam_identification_type_id = read_results[0].l10n_latam_identification_type_id;
                                if( String(l10n_latam_identification_type_id) == String("") )
                                {}
                                else
                                    {
                                        $('input#l10n_latam_identification_type_id').select2('data', { id: l10n_latam_identification_type_id[0], text: l10n_latam_identification_type_id[1], create: false }, false);
                                    }
